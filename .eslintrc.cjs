				...
				'@byondxr/automate/react-wrap': [
					'error',
					{
						...
						banDisableDepsEslint:
							'(useAsync|useUpdateEffect|useShallowCompareEffect|useRecoilMemoSelector|useRecoilEffect|useRecoilMemoParamSelector)',
						wrapHandler: {
							wrapName: 'useHandler',
							importSource: '@byondxr/react-utils',
							replaces: '(effectDep)',
				...
				'@byondxr/automate/exhaustive-deps': [
					'error',
					{
						hooksToIncludeAllDependencies:
							'(useRecoilMemoSelector|useRecoilMemoParamSelector|useRecoilMemoValue)',
						enableDangerousAutofixThisMayCauseInfiniteLoops: true,
						useEffectRemoveUnnecessaryDependencies: true,
						useEffectDisregardFunctions: true,
						additionalHooks:
							'(useAsync|useUpdateEffect|useShallowCompareEffect|useRecoilMemoSelector|useRecoilEffect|useRecoilMemoParamSelector|useRecoilMemoValue)',
						additionalStableHandlers:
							'(useLatest|useHandler|useConst|useRecoilAtom|useRecoilLocalAtom|useSignal)',
					},
				],
			},
		},
